(() => {
  ...
  var require_jiuxing = __commonJS({
    "lib/jiuxing.js"(exports, module) {
      ...
      function distributeJiuXing(diPan, xunShou, shiGan) {
        ...
        const zhiFuGong = zhiFuGongRaw === "5" ? "2" : zhiFuGongRaw;
        const zhiFuXing = zhiFuGongRaw === "5" ? "\u5929\u79BD" : BASIC_XING[zhiFuGong];
        if (!shiGan) {
          return {
            zhiFuGong,
            zhiFuGongRaw,
        ...
        return {
          zhiFuGong,
          // 值符原位宫（旬首六仪在地盘的位置，含中5已寄坤2）
          zhiFuGongRaw,
          // 值符原位宫真实值（含中宫5，未寄坤2，供值使数步起算用）
  ...
  var require_bamen = __commonJS({
    "lib/bamen.js"(exports, module) {
      ...
      function distributeBaMen(zhiFuGong, zhiFuGongRaw, shiGan, type = "yang") {
        const zhiShiMen = BASIC_MEN[zhiFuGong] || "";
        const step = TIAN_GAN.indexOf(shiGan);
        let g = parseInt(zhiFuGongRaw, 10);
        for (let i = 0; i < Math.max(step, 0); i++) {
          g += type === "yang" ? 1 : -1;
          if (g > 9) g = 1;
          if (g < 1) g = 9;
        }
  ...
  var require_jieduan = __commonJS({
    "lib/jieduan.js"(exports, module) {
      ...
      var YONG_SHEN_MAP = {
        ...
        "\u5C04\u8986": { items: [{ kind: "shen", name: "\u503C\u7B26" }, { kind: "men", name: "\u666F\u95E8" }], tip: "\u5C04\u8986(\u731C\u7269/\u6570\u5B57/\u8C1C)\uFF1A\u4EE5\u503C\u7B26\u3001\u503C\u4F7F\u3001\u7528\u795E\u5BAB\u4E4B\u516B\u5366\u7C7B\u8C61\u4E0E\u5929\u5730\u76D8\u5E72\u4E4B\u6CB3\u56FE\u6570\u63A8\u4E4B\uFF1B\u6570\u5B57\u5B9C\u7ED3\u5408\u65FA\u8870\u3002\u8BE6\u5C3D\u63A8\u65AD\u89C1\u201CAI \u5360\u535C\u201D\u3002" },
        "\u5929\u6C14": { items: [{ kind: "xing", name: "\u5929\u84EC" }, { kind: "xing", name: "\u5929\u82F1" }], tip: "\u5929\u6C14\uFF1A\u96E8\u770B\u5929\u84EC/\u58EC\u7678\uFF0C\u6674\u770B\u5929\u82F1/\u4E19\u4E01\uFF0C\u4EE5\u5176\u843D\u5BAB\u65FA\u8870\u3001\u95E8\u5BAB\u683C\u65AD\u9634\u6674\u3002" },
        "\u6000\u5B55": { items: [{ kind: "xing", name: "\u5929\u82AE" }, { kind: "men", name: "\u751F\u95E8" }], tip: "\u4EA7\u80B2\u770B\u5929\u82AE(\u5B55\u6BCD)\u3001\u751F\u95E8(\u80CE\u4EA7)\uFF1B\u7537\u5973\u770B\u9634\u9633\uFF0C\u751F\u95E8\u65FA\u5409\u987A\u4EA7\uFF0C\u9022\u6B7B\u4F24\u95E8\u3001\u5165\u5893\u7A7A\u4EA1\u5219\u51F6\u3002" },
        "\u5B98\u53F8": { items: [{ kind: "men", name: "\u5F00\u95E8" }, { kind: "gan", name: "\u5E9A" }], tip: "\u5B98\u53F8\u770B\u5F00\u95E8(\u5B98\u957F/\u6CD5\u5B98)\u3001\u5E9A(\u8BBC/\u5BF9\u5934)\uFF1B\u5929\u76D8\u4E3A\u5BA2\u5730\u76D8\u4E3A\u4E3B\uFF0C\u5F00\u95E8\u751F\u6211\u514B\u5F7C\u5219\u80DC\u3002" },
        "\u98CE\u6C34": { items: [{ kind: "men", name: "\u751F\u95E8" }, { kind: "men", name: "\u6B7B\u95E8" }], tip: "\u98CE\u6C34\uFF1A\u9633\u5B85\u770B\u4E2D\u5BAB/\u503C\u4F7F/\u751F\u95E8\u65FA\u76F8\uFF0C\u9634\u5B85\u770B\u6B7B\u95E8/\u4E5D\u5730/\u575F\u8314\uFF1B\u4EE5\u5176\u4E0E\u5E74\u547D\u4E4B\u751F\u514B\u5B9A\u65FA\u8870\u5409\u51F6\u3002" },
        "\u5BFB\u4EBA": { items: [{ kind: "shen", name: "\u516D\u5408" }, { kind: "shen", name: "\u592A\u9634" }], tip: "\u5BFB\u4EBA\u8FFD\u8E2A\uFF1A\u7537\u770B\u516D\u5408\u3001\u5973\u770B\u592A\u9634(\u6216\u5E74\u547D)\uFF0C\u4EE5\u5176\u843D\u5BAB\u5B9A\u65B9\u4F4D\uFF0C\u751F\u5E74\u547D\u3001\u95E8\u5409\u5219\u53EF\u5BFB\u89C1\u3002" },
        "\u7EFC\u5408": { items: [{ kind: "shen", name: "\u503C\u7B26" }], tip: "\u7EFC\u5408\uFF1A\u4EE5\u503C\u7B26\u3001\u503C\u4F7F\u53CA\u5168\u76D8\u65FA\u8870\u751F\u514B\u51B2\u5408\u7EFC\u89C2\uFF0C\u65E0\u4E13\u4E00\u7528\u795E\u3002" }
      };
      ...
      function normalizeFeipan(pan) {
        return {
          jiuXing: pan.tianPanXing || {},
          baMen: pan.renPanMen || {},
          baShen: pan.tianPanShen || {},
          tianPan: pan.tianPanYi || {},
          diPan: pan.diPan || {},
          anGan: pan.diPanAnGan || {},
          zhiFuGong: pan.zhiFuLuoGong || pan.zhiFuGong,
          zhiShiGong: pan.zhiShiGong,
          kongWangGong: pan.kongWangGong || [],
          maStar: pan.maStar || { zhi: "", gong: "" },
          siZhu: pan.siZhu,
  ...
  var require_qimen = __commonJS({
    "lib/qimen.js"(exports, module) {
      ...
      function getPreciseJieQiName(lunar, date) {
        let jq = lunar.getPrevJieQi(true);
        const ms = new Date(jq.getSolar().toYmdHms().replace(" ", "T")).getTime();
        if (ms > date.getTime()) {
          jq = Lunar.fromDate(new Date(ms - 864e5)).getPrevJieQi(true);
        }
        return jq.getName();
      }
      function calculateJuShu(date, method = "\u65F6\u5BB6") {
        ...
        if (method === "\u65F6\u5BB6" || method === "\u65E5\u5BB6") {
          jieQiName = getPreciseJieQiName(lunar, date);
        } else if (method === "\u6708\u5BB6") {
      ...
      function getLuoGongGanZhi(lunar, method) {
        try {
          if (method === "\u65F6\u5BB6") {
            ...
            return lunar.getDayInGanZhiExact().substring(0, 1);
          } else if (method === "\u6708\u5BB6") {
      ...
      function calculate(date, options = {}) {
        ...
        try {
          ...
          const baMenResult = baMenModule.distributeBaMen(jiuXingResult.zhiFuGong, jiuXingResult.zhiFuGongRaw || jiuXingResult.zhiFuGong, luoGongGan, juShu.type);
  ...
  // lib/feipan-jiuxing.js
  var require_feipan_jiuxing = __commonJS({
    "lib/feipan-jiuxing.js"(exports, module) {
      var YUAN_DAN_PAN_XING = ["\u5929\u84EC", "\u5929\u82AE", "\u5929\u51B2", "\u5929\u8F85", "\u5929\u79BD", "\u5929\u5FC3", "\u5929\u67F1", "\u5929\u4EFB", "\u5929\u82F1"];
      var YUAN_DAN_PAN_MEN = ["\u4F11\u95E8", "\u6B7B\u95E8", "\u4F24\u95E8", "\u675C\u95E8", "\u9EC4\u95E8", "\u5F00\u95E8", "\u60CA\u95E8", "\u751F\u95E8", "\u666F\u95E8"];
      var XING_CYCLE = ["\u5929\u84EC", "\u5929\u82AE", "\u5929\u51B2", "\u5929\u8F85", "\u5929\u79BD", "\u5929\u5FC3", "\u5929\u67F1", "\u5929\u4EFB", "\u5929\u82F1"];
      var SHEN_CYCLE_YANG = ["\u503C\u7B26", "\u817E\u86C7", "\u592A\u9634", "\u516D\u5408", "\u52FE\u9648", "\u592A\u5E38", "\u6731\u96C0", "\u4E5D\u5730", "\u4E5D\u5929"];
      var SHEN_CYCLE_YIN = ["\u503C\u7B26", "\u817E\u86C7", "\u592A\u9634", "\u516D\u5408", "\u767D\u864E", "\u592A\u5E38", "\u7384\u6B66", "\u4E5D\u5730", "\u4E5D\u5929"];
      function fillDirectional(cycle, anchorIdentity, anchorGong, type) {
        const startIdx = cycle.indexOf(anchorIdentity);
        const anchor = parseInt(anchorGong, 10);
        const dir = type === "yin" ? -1 : 1;
        const result = {};
        for (let i = 0; i < 9; i++) {
          let g = anchor + dir * i;
          while (g > 9) g -= 9;
          while (g < 1) g += 9;
          result[g.toString()] = cycle[(startIdx + i) % 9];
        }
        return result;
      }
      function distributeJiuXing(diPan, xunShouYi, shiGan, type) {
        let zhiFuGong = "";
        for (const gong in diPan) {
          if (diPan[gong] === xunShouYi) {
            zhiFuGong = gong;
            break;
          }
        }
        ...
        const zhiFuIdx = parseInt(zhiFuGong, 10) - 1;
        const zhiFuXing = YUAN_DAN_PAN_XING[zhiFuIdx];
        const zhiShiMen = YUAN_DAN_PAN_MEN[zhiFuIdx];
        let zhiFuLuoGong = "";
        if (shiGan === "\u7532") {
        ...
        const shenCycle = type === "yin" ? SHEN_CYCLE_YIN : SHEN_CYCLE_YANG;
        const tianPanXing = fillDirectional(XING_CYCLE, zhiFuXing, zhiFuLuoGong, type);
        const tianPanShen = fillDirectional(shenCycle, "\u503C\u7B26", zhiFuLuoGong, type);
        const diPanShen = fillDirectional(shenCycle, "\u503C\u7B26", zhiFuGong, type);
        return { zhiFuGong, zhiFuXing, zhiShiMen, zhiFuLuoGong, tianPanXing, tianPanShen, diPanShen };
      }
      module.exports = {
        distributeJiuXing,
        YUAN_DAN_PAN_XING,
  ...
  // lib/feipan-bamen.js
  var require_feipan_bamen = __commonJS({
    "lib/feipan-bamen.js"(exports, module) {
      var TIAN_GAN = ["\u7532", "\u4E59", "\u4E19", "\u4E01", "\u620A", "\u5DF1", "\u5E9A", "\u8F9B", "\u58EC", "\u7678"];
      var MEN_CYCLE = ["\u5F00\u95E8", "\u60CA\u95E8", "\u751F\u95E8", "\u666F\u95E8", "\u4F11\u95E8", "\u6B7B\u95E8", "\u4F24\u95E8", "\u675C\u95E8", "\u9EC4\u95E8"];
      function distributeBaMen(xunShouGong, zhiShiMen, shiGan, type) {
        const step = TIAN_GAN.indexOf(shiGan);
        let g = parseInt(xunShouGong, 10);
        for (let i = 0; i < step; i++) {
          g += type === "yin" ? -1 : 1;
          if (g > 9) g = 1;
          if (g < 1) g = 9;
        }
        const zhiShiGong = g.toString();
        const startIdx = MEN_CYCLE.indexOf(zhiShiMen);
        const anchor = g;
        const dir = type === "yin" ? -1 : 1;
        const renPanMen = {};
        for (let i = 0; i < 9; i++) {
          ...
          while (p > 9) p -= 9;
          while (p < 1) p += 9;
          renPanMen[p.toString()] = MEN_CYCLE[(startIdx + i) % 9];
        }
        return { zhiShiGong, renPanMen };
      }
      module.exports = {
        distributeBaMen
      };
  ...
  // lib/feipan-angan.js
  var require_feipan_angan = __commonJS({
    "lib/feipan-angan.js"(exports, module) {
      var TIAN_GAN = ["\u7532", "\u4E59", "\u4E19", "\u4E01", "\u620A", "\u5DF1", "\u5E9A", "\u8F9B", "\u58EC", "\u7678"];
      var DI_ZHI = ["\u5B50", "\u4E11", "\u5BC5", "\u536F", "\u8FB0", "\u5DF3", "\u5348", "\u672A", "\u7533", "\u9149", "\u620C", "\u4EA5"];
      function distributeAnGan(xunShouGanZhi, xunShouGong, type) {
        const ganStart = TIAN_GAN.indexOf(xunShouGanZhi.charAt(0));
        const zhiStart = DI_ZHI.indexOf(xunShouGanZhi.charAt(1));
        const result = {};
        let g = parseInt(xunShouGong, 10);
        for (let i = 0; i < 9; i++) {
          const gan = TIAN_GAN[(ganStart + i) % 10];
          const zhi = DI_ZHI[(zhiStart + i) % 12];
          result[g.toString()] = gan + zhi;
          g += type === "yin" ? -1 : 1;
          if (g > 9) g = 1;
          if (g < 1) g = 9;
        }
  ...
  // lib/feipan-tianpan.js
  var require_feipan_tianpan = __commonJS({
    "lib/feipan-tianpan.js"(exports, module) {
      var SAN_QI_LIU_YI = ["\u620A", "\u5DF1", "\u5E9A", "\u8F9B", "\u58EC", "\u7678", "\u4E01", "\u4E19", "\u4E59"];
      function distributeTianPan(xunShouYi, zhiFuLuoGong, type) {
        const startIdx = SAN_QI_LIU_YI.indexOf(xunShouYi);
        const result = {};
        let g = parseInt(zhiFuLuoGong, 10);
        for (let i = 0; i < 9; i++) {
          result[g.toString()] = SAN_QI_LIU_YI[(startIdx + i) % 9];
          g += type === "yin" ? -1 : 1;
          if (g > 9) g = 1;
          if (g < 1) g = 9;
        }
  ...
  // lib/feipan-qimen.js
  var require_feipan_qimen = __commonJS({
    "lib/feipan-qimen.js"(exports, module) {
      var { Lunar, Solar } = require_lunar_javascript();
      var qimenModule = require_qimen();
      var dipanModule = require_dipan();
      var feipanJiuXingModule = require_feipan_jiuxing();
      var feipanBaMenModule = require_feipan_bamen();
      var feipanAnGanModule = require_feipan_angan();
      var feipanTianPanModule = require_feipan_tianpan();
      var jieduanModule = require_jieduan();
      var DUI_CHONG = { "1": "9", "2": "8", "3": "7", "4": "6", "5": "5", "6": "4", "7": "3", "8": "2", "9": "1" };
      function calculate(date, opts = {}) {
        const options = Object.assign({ method: "\u65F6\u5BB6" }, opts);
        try {
          const lunar = Lunar.fromDate(date);
          const solar = Solar.fromDate(date);
          const siZhu = {
          ...
          const juShu = qimenModule.calculateJuShu(date, options.method);
          const xunShouYi = qimenModule.getXunShou(lunar, options.method);
          const shiGan = qimenModule.getLuoGongGanZhi(lunar, options.method);
          const diPan = dipanModule.getDiPan(juShu.type, parseInt(juShu.number, 10));
          const jx = feipanJiuXingModule.distributeJiuXing(diPan, xunShouYi, shiGan, juShu.type);
          const bm = feipanBaMenModule.distributeBaMen(jx.zhiFuGong, jx.zhiShiMen, shiGan, juShu.type);
          const duiChongGong = DUI_CHONG[jx.zhiFuGong];
          const anZhiShiMen = feipanJiuXingModule.YUAN_DAN_PAN_MEN[parseInt(duiChongGong, 10) - 1];
          const flipType = juShu.type === "yang" ? "yin" : "yang";
          const ab = feipanBaMenModule.distributeBaMen(duiChongGong, anZhiShiMen, shiGan, flipType);
          const xunShouGanZhi = lunar.getTimeXun ? lunar.getTimeXun() : null;
          if (!xunShouGanZhi) {
            throw new Error("\u65E0\u6CD5\u83B7\u53D6\u65EC\u9996\u5E72\u652F(getTimeXun\u8FD4\u56DE\u7A7A)");
          }
          const diPanAnGan = feipanAnGanModule.distributeAnGan(xunShouGanZhi, jx.zhiFuGong, juShu.type);
          const tianPanAnGan = feipanAnGanModule.distributeAnGan(xunShouGanZhi, jx.zhiFuLuoGong, juShu.type);
          const renPanAnGan = feipanAnGanModule.distributeAnGan(xunShouGanZhi, bm.zhiShiGong, juShu.type);
          const tianPanYi = feipanTianPanModule.distributeTianPan(xunShouYi, jx.zhiFuLuoGong, juShu.type);
          const kongWangZhi = qimenModule.getKongWang(lunar, options.method);
          const kongWangGong = qimenModule.getKongWangGong(kongWangZhi);
          const maStar = qimenModule.getMaStar(lunar, options.method);
          const pan = {
            basicInfo: {
              date: solar.toFullString(),
              lunarDate: lunar.toString(),
              ...
              school: "feipan-kuonang"
            },
            siZhu,
            juShu,
            xunShou: xunShouYi,
            // 旬首六仪（与转盘同名字段，供视图「旬首」显示）
            xunShouYi,
            zhiFuGong: jx.zhiFuGong,
            zhiFuXing: jx.zhiFuXing,
            zhiFuLuoGong: jx.zhiFuLuoGong,
            zhiShiMen: jx.zhiShiMen,
            zhiShiGong: bm.zhiShiGong,
            anZhiShiMen,
            anZhiShiGong: ab.zhiShiGong,
            // 天盘三元 + 暗干支
            tianPanXing: jx.tianPanXing,
            tianPanShen: jx.tianPanShen,
            tianPanYi,
            tianPanAnGan,
            // 人盘：明门 / 暗门 / 暗干支
            renPanMen: bm.renPanMen,
            renPanAnMen: ab.renPanMen,
            renPanAnGan,
            // 地盘三元 + 暗干支
            diPanShen: jx.diPanShen,
            diPan,
            diPanAnGan,
            // 空亡 / 驿马
            kongWangZhi,
          ...
          const { jiuGongAnalysis, geju, analysis } = jieduanModule.jieduan(jieduanModule.normalizeFeipan(pan));
          pan.jiuGongAnalysis = jiuGongAnalysis;
          pan.geju = geju;
          pan.analysis = analysis;
          return pan;
        } catch (e) {
          console.error("\u98DE\u76D8(\u9E23\u6CD5)\u8BA1\u7B97\u51FA\u9519:", e);
          return {
            error: true,
            message: e.message,
            basicInfo: {
              date: date.toLocaleString(),
              school: "feipan-mingfa"
            }
          };
        }
      }
  ...
  // lib/feipan-predict.js
  var require_feipan_predict = __commonJS({
    "lib/feipan-predict.js"(exports, module) {
      var fs = null;
      var nodePath = null;
      try {
        fs = __require("fs");
      ...
      var GONG_FANGWEI = {
        "1": { name: "\u574E", fangwei: "\u6B63\u5317", place: "\u6C9F\u6E20\u6C60\u5858\u3001\u9690\u4F0F\u4F4E\u6D3C\u3001\u6C34\u8FB9" },
        "2": { name: "\u5764", fangwei: "\u897F\u5357", place: "\u5E73\u539F\u90CA\u91CE\u3001\u5B66\u6821\u5708\u820D\u3001\u7530\u5730" },
        "3": { name: "\u9707", fangwei: "\u6B63\u4E1C", place: "\u4E1B\u6797\u9053\u8DEF\u3001\u8FD0\u52A8\u55A7\u95F9\u5904" },
        "4": { name: "\u5DFD", fangwei: "\u4E1C\u5357", place: "\u6587\u5316\u573A\u6240\u3001\u82D7\u5703\u82B1\u575B" },
        "5": { name: "\u4E2D", fangwei: "\u4E2D\u592E/\u5BA4\u5185", place: "\u5185\u5BA4\u5EAD\u9662\u3001\u7A9D\u7A74\u3001\u8D34\u8EAB\u4E4B\u6240\u3001\u5BB6" },
        "6": { name: "\u4E7E", fangwei: "\u897F\u5317", place: "\u9AD8\u4EA2\u4E4B\u6240\u3001\u795E\u5E99\u3001\u9AD8\u5904" },
        "7": { name: "\u5151", fangwei: "\u6B63\u897F", place: "\u6C9F\u6E20\u6B4C\u5854\u3001\u55A7\u54D7\u8A00\u8BF4\u4E4B\u5730" },
        "8": { name: "\u826E", fangwei: "\u4E1C\u5317", place: "\u5824\u575D\u5C71\u5761\u3001\u57CE\u5899\u5C71\u91CE\u3001\u684C\u67DC\u95E8\u5F84\u4E0B\u65C1" },
        "9": { name: "\u79BB", fangwei: "\u6B63\u5357", place: "\u95F9\u5E02\u7089\u51B6\u3001\u660E\u4EAE\u5904\u3001\u6587\u4E66" }
      };
      var GAN_HETU = { "\u7532": 3, "\u4E59": 8, "\u4E19": 7, "\u4E01": 2, "\u620A": 5, "\u5DF1": 10, "\u5E9A": 9, "\u8F9B": 4, "\u58EC": 1, "\u7678": 6 };
      var YONG_SHEN_RULES = [
        { category: "\u6C42\u8D22", keywords: ["\u6C42\u8D22", "\u8D22\u8FD0", "\u94B1", "\u8D5A", "\u6295\u8D44", "\u751F\u610F", "\u5229\u6DA6"], yongshen: [{ kind: "men", name: "\u751F\u95E8" }], note: "\u751F\u95E8\u5BAB\u751F\u6276/\u6BD4\u6276/\u514B\u5E74\u547D\u2192\u5F97\u8D22\uFF1B\u5E74\u547D\u88AB\u751F\u95E8\u8131\u6CC4\u2192\u635F\u8D22\u3002" },
        { category: "\u529F\u540D", keywords: ["\u529F\u540D", "\u8003\u8BD5", "\u5347\u804C", "\u4ED5\u9014", "\u5B98\u804C", "\u8003"], yongshen: [{ kind: "men", name: "\u5F00\u95E8" }], note: "\u5F00\u95E8\u5BAB\u5BF9\u5E74\u547D/\u4E3B\u5BA2\u4E4B\u751F\u514B\u5B9A\u6210\u8D25\u3002" },
        { category: "\u8BCD\u8BBC", keywords: ["\u8BCD\u8BBC", "\u5B98\u53F8", "\u8BC9\u8BBC", "\u6253\u5B98\u53F8", "\u5B98\u975E", "\u7EA0\u7EB7"], yongshen: [{ kind: "men", name: "\u5F00\u95E8" }], note: "\u5F00\u95E8\u4E3A\u6CD5\u5B98\uFF1B\u4E0D\u77E5\u53CC\u65B9\u5E74\u547D\u5219\u5929\u4E59=\u539F\u544A\u3001\u5730\u4E59=\u88AB\u544A\u3002" },
        { category: "\u5BFB\u7269", keywords: ["\u5BFB\u7269", "\u5931\u7269", "\u4E22", "\u627E", "\u627E\u56DE", "\u94A5\u5319", "\u4E22\u5931", "\u4E0D\u89C1", "\u6389"], yongshen: [{ kind: "men", name: "\u4F24\u95E8" }, { kind: "shen", name: "\u7384\u6B66" }], note: "\u4F24\u95E8\u751F\u6276/\u6BD4\u6276/\u53D7\u5236\u5E74\u547D\u2192\u5BFB\u7269\u6709\u679C\uFF1B\u4F24\u95E8\u514B\u6216\u8131\u6CC4\u5E74\u547D\u2192\u65E0\u679C\u3002\u65B9\u4F4D\u770B\u4F24\u95E8\u6216\u7384\u6B66\u843D\u5BAB\u3002" },
        { category: "\u8FFD\u6355", keywords: ["\u8FFD\u6355", "\u6293", "\u7F09\u62FF", "\u9003\u72AF"], yongshen: [{ kind: "men", name: "\u4F24\u95E8" }, { kind: "shen", name: "\u516D\u5408" }], note: "\u4F24\u95E8\u514B\u516D\u5408\u2192\u7F09\u62FF\u5F52\u6848\uFF1B\u4F24\u95E8\u751F\u516D\u5408\u2192\u65E0\u679C\u3002" },
        { category: "\u8BA8\u503A", keywords: ["\u8BA8\u503A", "\u6B20\u94B1", "\u8981\u8D26", "\u8FD8\u94B1"], yongshen: [{ kind: "men", name: "\u4F24\u95E8" }, { kind: "sanyi", name: "\u5929\u4E59" }], note: "\u4F24\u95E8\u514B\u5929\u4E59(\u6B20\u503A\u4EBA)\u2192\u8BA8\u503A\u5F97\u5229\uFF1B\u5929\u4E59\u514B\u4F24\u95E8\u2192\u96BE\u8BA8\u3002" },
        { category: "\u5A5A\u59FB", keywords: ["\u5A5A\u59FB", "\u611F\u60C5", "\u7ED3\u5A5A", "\u5BF9\u8C61", "\u604B\u7231", "\u59FB\u7F18"], yongshen: [{ kind: "men", name: "\u4F11\u95E8" }, { kind: "shen", name: "\u516D\u5408" }], note: "\u4F11\u95E8\u4E3A\u559C\u795E\uFF1B\u4E0D\u77E5\u5E74\u547D\u5219\u5929\u4E59=\u7537\u5BB6\u3001\u5730\u4E59=\u5973\u5BB6\u3001\u516D\u5408=\u5A92\u3002" },
        { category: "\u9003\u4EA1", keywords: ["\u9003\u4EA1", "\u51FA\u8D70", "\u79BB\u5BB6", "\u8D70\u5931"], yongshen: [{ kind: "shen", name: "\u516D\u5408" }, { kind: "shen", name: "\u592A\u9634" }], note: "\u7537\u770B\u516D\u5408\u3001\u5973\u770B\u592A\u9634\uFF1B\u4E09\u9690\u5BAB=\u516D\u5408(\u90CA\u91CE)/\u592A\u9634(\u9690\u853D)/\u4E5D\u5730(\u4F4E\u6D3C)\u3002" },
        { category: "\u907F\u96BE", keywords: ["\u907F\u96BE", "\u8EB2", "\u6F5C\u884C", "\u9003\u907F"], yongshen: [{ kind: "men", name: "\u675C\u95E8" }], note: "\u675C\u95E8\u751F\u5E74\u547D\u5409\u3001\u514B\u5E74\u547D\u5FE7\u3001\u5E74\u547D\u514B\u675C\u95E8\u4E3A\u5E86\u3002" },
        { category: "\u6587\u4E66\u97F3\u8BAF", keywords: ["\u6587\u4E66", "\u6D88\u606F", "\u97F3\u8BAF", "\u4FE1", "\u901A\u77E5", "\u56DE\u590D"], yongshen: [{ kind: "men", name: "\u666F\u95E8" }, { kind: "shen", name: "\u6731\u96C0" }], note: "\u6731\u96C0\u4EE5\u4E01\u5947\u4E3A\u5143\u7CBE\u3002" },
        { category: "\u75BE\u75C5", keywords: ["\u75BE\u75C5", "\u75C5", "\u5065\u5EB7", "\u8EAB\u4F53", "\u751F\u75C5"], yongshen: [{ kind: "xing", name: "\u5929\u82AE" }, { kind: "men", name: "\u751F\u95E8" }, { kind: "men", name: "\u6B7B\u95E8" }], note: "\u82AE\u5185\u76D8\u770B\u5947\u4EEA\u3001\u5916\u76D8\u770B\u5366\u5BAB\uFF1B\u751F\u95E8\u4E3A\u751F\u3001\u6B7B\u95E8\u4E3A\u6B7B\u3002" },
        { category: "\u53E3\u820C\u6597\u6BB4", keywords: ["\u53E3\u820C", "\u5435\u67B6", "\u6597\u6BB4", "\u6253\u67B6", "\u662F\u975E"], yongshen: [{ kind: "men", name: "\u60CA\u95E8" }], note: "\u60CA\u95E8\u503C\u6731\u96C0\u2192\u53E3\u820C\u3001\u503C\u767D\u864E\u2192\u6597\u6BB4\u3002" },
        { category: "\u5BB6\u5B85", keywords: ["\u5BB6\u5B85", "\u642C\u5BB6", "\u4F4F\u5F97"], yongshen: [{ kind: "sanyi", name: "\u592A\u4E59" }], note: "\u4EE5\u5B88\u95E8\u683C(\u503C\u4F7F+\u5730\u76D8\u5947\u4EEA)\u8BBA\uFF1B\u65F6\u5E72\u5468\u6E38\u4E2D\u4E94=\u5360\u95EE\u7684\u662F\u5BB6\u3002" },
        { category: "\u76D7\u8D3C", keywords: ["\u76D7\u8D3C", "\u5C0F\u5077", "\u88AB\u76D7", "\u5077"], yongshen: [{ kind: "shen", name: "\u7384\u6B66" }], note: "\u7384\u6B66\u5BAB\u4E0E\u5E74\u547D\u4E4B\u5173\u7CFB\u3002" },
        { category: "\u51FA\u884C", keywords: ["\u51FA\u884C", "\u65C5\u884C", "\u8FDC\u884C", "\u8DEF\u9014", "\u51FA\u95E8"], yongshen: [{ kind: "shen", name: "\u767D\u864E" }, { kind: "men", name: "\u5F00\u95E8" }], note: "\u767D\u864E\u5BAB\u8BBA\u8DEF\u9014\u5409\u51F6\u3002" },
        { category: "\u884C\u4EBA", keywords: ["\u884C\u4EBA", "\u6765\u4E0D\u6765", "\u4F55\u65F6\u5230", "\u56DE\u6765"], yongshen: [{ kind: "men", name: "\u5F00\u95E8" }], note: "\u770B\u884C\u4EBA\u65B9\u4F4D\u662F\u5426\u751F\u5E74\u547D\u3001\u5F00\u95E8\u548C\u4E49/\u8FDB\u795E\u2192\u5FC5\u6765\u3002" },
        { category: "\u5929\u6C14", keywords: ["\u5929\u6C14", "\u4E0B\u96E8", "\u4F1A\u4E0B\u96E8", "\u6674", "\u9634\u5929", "\u522E\u98CE", "\u96E8", "\u96EA", "\u53F0\u98CE", "\u66B4\u96E8", "\u4F1A\u4E0D\u4F1A\u4E0B"], yongshen: [{ kind: "xing", name: "\u5929\u84EC" }, { kind: "xing", name: "\u5929\u82F1" }], note: "\u96E8\u770B\u5929\u84EC/\u58EC\u7678\u3001\u6674\u770B\u5929\u82F1/\u4E19\u4E01\uFF0C\u4EE5\u5176\u5929\u76D8\u843D\u5BAB\u65FA\u8870\u3001\u95E8\u5BAB\u683C\u65AD\u9634\u6674\u98CE\u96EA\u3002" },
        { category: "\u6000\u5B55", keywords: ["\u6000\u5B55", "\u6000\u4E0A", "\u80FD\u4E0D\u80FD\u751F", "\u751F\u7537", "\u751F\u5973", "\u7537\u5B69", "\u5973\u5B69", "\u80CE", "\u4EA7", "\u5907\u5B55", "\u987A\u4EA7", "\u5256\u8179"], yongshen: [{ kind: "xing", name: "\u5929\u82AE" }, { kind: "men", name: "\u751F\u95E8" }], note: "\u4EA7\u80B2\u770B\u5929\u82AE(\u5B55\u6BCD)\u3001\u751F\u95E8(\u80CE\u4EA7)\uFF1B\u7537\u5973\u770B\u9634\u9633(\u9633\u5E72\u9633\u661F\u504F\u7537\u3001\u9634\u504F\u5973)\uFF0C\u751F\u95E8\u65FA\u5409\u987A\u4EA7\uFF0C\u9022\u6B7B\u4F24\u95E8/\u5165\u5893\u7A7A\u4EA1\u5219\u51F6\u3002" },
        { category: "\u5B98\u53F8", keywords: ["\u5B98\u53F8", "\u8BC9\u8BBC", "\u8BCD\u8BBC", "\u6253\u5B98\u53F8", "\u7EA0\u7EB7", "\u5B98\u975E", "\u4EF2\u88C1", "\u8D77\u8BC9", "\u80DC\u8BC9", "\u8D25\u8BC9", "\u5224"], yongshen: [{ kind: "men", name: "\u5F00\u95E8" }, { kind: "gan", name: "\u5E9A" }], note: "\u5F00\u95E8\u4E3A\u6CD5\u5B98\u3001\u5E9A\u4E3A\u8BBC\u5BF9\u5934\uFF1B\u5929\u76D8\u4E3A\u5BA2\u5730\u76D8\u4E3A\u4E3B\uFF0C\u5F00\u95E8\u751F\u6211\u514B\u5F7C\u5219\u80DC\u3002" },
        { category: "\u98CE\u6C34", keywords: ["\u98CE\u6C34", "\u9633\u5B85", "\u9634\u5B85", "\u575F", "\u5893\u5730", "\u4F4F\u5B85", "\u623F\u5B50", "\u5B85", "\u642C", "\u88C5\u4FEE", "\u5750\u5411"], yongshen: [{ kind: "men", name: "\u751F\u95E8" }, { kind: "men", name: "\u6B7B\u95E8" }], note: "\u9633\u5B85\u770B\u4E2D\u5BAB/\u503C\u4F7F/\u751F\u95E8\u65FA\u76F8\uFF0C\u9634\u5B85\u770B\u6B7B\u95E8/\u4E5D\u5730/\u575F\u8314\uFF1B\u4EE5\u5176\u4E0E\u5E74\u547D\u4E4B\u751F\u514B\u5B9A\u65FA\u8870\u5409\u51F6\u3002" },
        { category: "\u5BFB\u4EBA", keywords: ["\u5BFB\u4EBA", "\u627E\u4EBA", "\u4EBA\u5728\u54EA", "\u8D70\u5931", "\u5931\u8E2A", "\u4E0B\u843D", "\u884C\u8E2A", "\u8FFD\u8E2A", "\u8DD1\u54EA", "\u5728\u54EA\u91CC"], yongshen: [{ kind: "shen", name: "\u516D\u5408" }, { kind: "shen", name: "\u592A\u9634" }], note: "\u5BFB\u4EBA\uFF1A\u7537\u770B\u516D\u5408\u3001\u5973\u770B\u592A\u9634(\u6216\u5E74\u547D)\uFF0C\u5176\u843D\u5BAB\u5B9A\u65B9\u4F4D\uFF0C\u751F\u5E74\u547D\u3001\u95E8\u5409\u5219\u53EF\u5BFB\u89C1\u3002" },
        { category: "\u5C04\u8986", keywords: ["\u5C04\u8986", "\u731C", "\u6570\u5B57", "\u51E0\u4E2A", "\u591A\u5C11", "\u4EF7\u683C", "\u591A\u5C11\u94B1", "\u5206\u6570", "\u8003\u591A\u5C11", "\u51E0\u5206", "\u53F7\u7801", "\u8C1C", "\u662F\u4EC0\u4E48", "\u731C\u7269", "\u51E0\u6837"], yongshen: [{ kind: "sanyi", name: "\u5929\u4E59" }], note: "\u5C04\u8986/\u6570\u5B57\uFF1A\u4EE5\u503C\u7B26\u503C\u4F7F\u7528\u795E\u5BAB\u4E4B\u516B\u5366\u7C7B\u8C61 + \u5929\u5730\u76D8\u5E72\u4E4B\u6CB3\u56FE\u6570(\u7532\u4E593\xB78\u2026)\uFF0C\u7ED3\u5408\u65FA\u8870\u63A8\u5177\u4F53\u6570/\u7269\u3002" }
      ];
      function findGongByValue(map, target) {
        if (!map || !target) return "";
        for (const g of ["1", "2", "3", "4", "5", "6", "7", "8", "9"]) {
          if (map[g] === target) return g;
        }
        return "";
      }
      function computeSanYiSiGong(pan, opts = {}) {
        const tianYi = findGongByValue(pan.tianPanShen, "\u503C\u7B26") || pan.zhiFuLuoGong || "";
        const diYi = findGongByValue(pan.diPanShen, "\u503C\u7B26") || pan.zhiFuGong || "";
        const taiYi = pan.zhiShiGong || "";
        const shiGan = (pan.siZhu && pan.siZhu.time || "").charAt(0);
        const shiGanGong = shiGan === "\u7532" ? pan.zhiFuLuoGong || "" : findGongByValue(pan.tianPanYi, shiGan) || "";
        const nianMingGan = opts.nianMingGan || "";
        const nianMingGong = nianMingGan ? findGongByValue(pan.tianPanYi, nianMingGan) || "" : "";
        return {
          tianYi,
          taiYi,
          diYi,
          ...
          nianMingGan,
          detail: {
            \u5929\u4E59: tianYi ? `${tianYi}\u5BAB(${(GONG_FANGWEI[tianYi] || {}).name || ""}) \u2014 \u4E3B\u4E8B\u60C5\u5F00\u59CB` : "",
            \u592A\u4E59: taiYi ? `${taiYi}\u5BAB(${(GONG_FANGWEI[taiYi] || {}).name || ""}) \u2014 \u4E3B\u8FC7\u7A0B` : "",
            \u5730\u4E59: diYi ? `${diYi}\u5BAB(${(GONG_FANGWEI[diYi] || {}).name || ""}) \u2014 \u4E3B\u7ED3\u5C40` : "",
            \u65F6\u5E72\u5BAB: shiGanGong ? `${shiGanGong}\u5BAB(${(GONG_FANGWEI[shiGanGong] || {}).name || ""}) \u2014 \u7980\u76D8\u4E3B\u5BB0` : "",
            \u5E74\u547D\u5BAB: nianMingGong ? `${nianMingGong}\u5BAB(${(GONG_FANGWEI[nianMingGong] || {}).name || ""})` : "\uFF08\u672A\u63D0\u4F9B\u5E74\u547D\uFF0C\u65E0\u6CD5\u5B9A\u4F4D\uFF09"
          }
        };
      }
      function classifyQuestion(question, category) {
        if (category) {
          const r = YONG_SHEN_RULES.find((x) => x.category === category);
          if (r) return { category: r.category, note: r.note, yongshen: r.yongshen, matched: true };
        }
        const q = question || "";
        for (const r of YONG_SHEN_RULES) {
          if (r.keywords.some((k) => q.includes(k))) {
            return { category: r.category, note: r.note, yongshen: r.yongshen, matched: true };
          }
        }
        return { category: "\u7EFC\u5408", note: "\u672A\u8BC6\u522B\u4E3A\u7279\u5B9A\u5360\u7C7B\uFF0C\u6309\u901A\u7528\u6CD5\uFF1A\u4EE5\u4E09\u4E59\u56DB\u5BAB\u3001\u503C\u7B26\u503C\u4F7F\u3001\u7528\u795E\u5E74\u547D\u4E4B\u751F\u514B\u51B2\u5408\u7EFC\u5408\u8BBA\u65AD\u3002", yongshen: [], matched: false };
      }
      function locateYongShen(pan, item, sanyi) {
        if (item.kind === "men") return findGongByValue(pan.renPanMen, item.name);
        if (item.kind === "shen") return findGongByValue(pan.tianPanShen, item.name);
        if (item.kind === "xing") return findGongByValue(pan.tianPanXing, item.name);
        if (item.kind === "gan") return findGongByValue(pan.tianPanYi, item.name);
        if (item.kind === "sanyi") {
          if (item.name === "\u5929\u4E59") return sanyi.tianYi;
          if (item.name === "\u592A\u4E59") return sanyi.taiYi;
          if (item.name === "\u5730\u4E59") return sanyi.diYi;
        }
        return "";
      }
      function selectYongShen(pan, question, opts = {}) {
        const cls = classifyQuestion(question, opts.category);
        const sanyi = opts._sanyi || computeSanYiSiGong(pan, opts);
        const located = cls.yongshen.map((item) => {
          const g = locateYongShen(pan, item, sanyi);
          const gf = GONG_FANGWEI[g] || {};
          return {
            name: item.name,
            kind: item.kind,
            gong: g,
            ...
            fangwei: gf.fangwei || "",
            place: gf.place || "",
            diPanYi: g ? pan.diPan && pan.diPan[g] : "",
            // 应期近：用神宫地盘奇仪
            diPanAnGan: g ? pan.diPanAnGan && pan.diPanAnGan[g] : ""
            // 应期远：地盘暗干支
          };
        });
        return { category: cls.category, note: cls.note, matched: cls.matched, located };
      }
      var SHEN_SHORT = { "\u503C\u7B26": "\u7B26", "\u817E\u86C7": "\u86C7", "\u592A\u9634": "\u9634", "\u516D\u5408": "\u5408", "\u52FE\u9648": "\u52FE", "\u592A\u5E38": "\u5E38", "\u6731\u96C0": "\u96C0", "\u4E5D\u5730": "\u5730", "\u4E5D\u5929": "\u5929", "\u767D\u864E": "\u864E", "\u7384\u6B66": "\u7384" };
      function serializeChart(pan) {
        const lines = [];
        const bi = pan.basicInfo || {};
        const sz = pan.siZhu || {};
        lines.push(`\u3010\u57FA\u672C\u3011\u516C\u5386:${bi.date || ""} \u519C\u5386:${bi.lunarDate || ""}`);
        lines.push(`\u3010\u56DB\u67F1\u3011\u5E74${sz.year || ""} \u6708${sz.month || ""} \u65E5${sz.day || ""} \u65F6${sz.time || ""}`);
        lines.push(`\u3010\u5C40\u3011${pan.juShu && pan.juShu.fullName || ""}\u3000\u65EC\u9996:${pan.xunShouYi || ""}`);
        lines.push(`\u3010\u503C\u7B26\u3011${pan.zhiFuXing || ""}\u843D${pan.zhiFuLuoGong || ""}\u5BAB\u3000\u3010\u660E\u503C\u4F7F\u3011${pan.zhiShiMen || ""}\u843D${pan.zhiShiGong || ""}\u5BAB\u3000\u3010\u6697\u503C\u4F7F\u3011${pan.anZhiShiMen || ""}\u843D${pan.anZhiShiGong || ""}\u5BAB`);
        lines.push("\u3010\u4E5D\u5BAB\u3011\u6BCF\u5BAB\uFF1A\u5BAB\u4F4D(\u65B9\u4F4D) | \u5929\u76D8[\u661F \u795E \u4EEA \u6697\u5E72\u652F] | \u4EBA\u76D8[\u660E\u95E8 \u6697\u95E8 \u6697\u5E72\u652F] | \u5730\u76D8[\u795E \u4EEA \u6697\u5E72\u652F]");
        for (const g of ["1", "2", "3", "4", "5", "6", "7", "8", "9"]) {
          const gf = GONG_FANGWEI[g] || {};
          const sh = (s) => SHEN_SHORT[s] || s || "";
          const t = `${(pan.tianPanXing || {})[g] || ""} ${sh((pan.tianPanShen || {})[g])} ${(pan.tianPanYi || {})[g] || ""} ${(pan.tianPanAnGan || {})[g] || ""}`.trim();
          const r = `${((pan.renPanMen || {})[g] || "").replace("\u95E8", "")} ${((pan.renPanAnMen || {})[g] || "").replace("\u95E8", "")} ${(pan.renPanAnGan || {})[g] || ""}`.trim();
          const d = `${sh((pan.diPanShen || {})[g])} ${(pan.diPan || {})[g] || ""} ${(pan.diPanAnGan || {})[g] || ""}`.trim();
          const kw = Array.isArray(pan.kongWangGong) && pan.kongWangGong.includes(g) ? " [\u7A7A\u4EA1]" : "";
          lines.push(`  ${g}\u5BAB(${gf.fangwei}): \u5929[${t}] \u4EBA[${r}] \u5730[${d}]${kw}`);
        }
        return lines.join("\n");
      }
      var _methodCache = null;
      function loadMethod(opts) {
        if (opts && typeof opts.methodText === "string") return opts.methodText;
        if (_methodCache !== null) return _methodCache;
        if (fs && nodePath) {
          try {
            _methodCache = fs.readFileSync(nodePath.join("/", "..", "kb", "feipan-mingfa", "jieduan-method.md"), "utf8");
          } catch (e) {
            _methodCache = "";
          }
        } else {
      ...
      function buildPrompt(pan, question, opts = {}) {
        const sanyi = computeSanYiSiGong(pan, opts);
        const yong = selectYongShen(pan, question, Object.assign({ _sanyi: sanyi }, opts));
        const chartText = serializeChart(pan);
        const yongLines = yong.located.length ? yong.located.map((y) => `  - ${y.name}\uFF1A\u843D${y.gong || "?"}\u5BAB(${y.fangwei || "?"}\uFF0C${y.place || ""})\uFF1B\u8BE5\u5BAB\u5730\u76D8\u5947\u4EEA=${y.diPanYi || "?"}(\u8FD1\u671F\u5E94\u671F)\u3001\u5730\u76D8\u6697\u5E72\u652F=${y.diPanAnGan || "?"}(\u8FDC\u671F\u5E94\u671F)`).join("\n") : "  - \uFF08\u672A\u5339\u914D\u7279\u5B9A\u5360\u7C7B\uFF0C\u6309\u4E09\u4E59\u56DB\u5BAB+\u503C\u7B26\u503C\u4F7F\u901A\u7528\u8BBA\u65AD\uFF09";
        const sanyiLines = Object.entries(sanyi.detail).map(([k, v]) => `  - ${k}\uFF1A${v}`).join("\n");
        const system = [
          '\u4F60\u662F\u4E00\u4F4D\u7CBE\u901A"\u9E23\u6CD5\u5947\u95E8\u9041\u7532"\u7684\u5360\u65AD\u5E08\u3002\u4E25\u683C\u4F9D\u636E\u4E0B\u65B9\u300A\u9E23\u6CD5\u5947\u95E8\xB7\u89E3\u65AD\u65B9\u6CD5\u7EB2\u8981\u300B\u7684\u7406\u8BBA\u4E0E\u884D\u8C61\u63A8\u7406\uFF0C',
          "\u4E0D\u5F97\u8131\u79BB\u76D8\u9762\u81C6\u9020\uFF1B\u63A8\u7406\u8981\u9010\u6B65\u5F15\u7528\u5177\u4F53\u5BAB\u4F4D\u5143\u7D20\u3001\u683C\u5C40\u4E0E\u751F\u514B\u5173\u7CFB\u3002\u6700\u7EC8\u7528\u7B80\u660E\u4E2D\u6587\u7ED9\u51FA\u7ED3\u8BBA\u3002",
          "",
          "=== \u89E3\u65AD\u65B9\u6CD5\u7EB2\u8981 ===",
          opts.includeMethod === false ? "(\u5DF2\u7701\u7565\uFF0C\u8C03\u7528\u65B9\u8D1F\u8D23\u6CE8\u5165)" : loadMethod(opts)
        ].join("\n");
        const user = [
          `\u3010\u5360\u95EE\u3011${question || "(\u672A\u586B\u5199)"}`,
          opts.nianMingGan ? `\u3010\u6C42\u6D4B\u4EBA\u5E74\u547D\u5929\u5E72\u3011${opts.nianMingGan}` : "\u3010\u6C42\u6D4B\u4EBA\u5E74\u547D\u3011\u672A\u63D0\u4F9B",
          "",
          "\u3010\u672C\u76D8\u3011",
          chartText,
          "",
          `\u3010\u5DF2\u4E3A\u4F60\u5B9A\u4F4D \xB7 \u5360\u7C7B\u3011${yong.category}\uFF08${yong.note}\uFF09`,
          "\u3010\u7528\u795E\u843D\u5BAB\u3011",
          yongLines,
          "\u3010\u4E09\u4E59\u56DB\u5BAB + \u5E74\u547D\u5BAB\u3011",
          sanyiLines,
          "",
          "\u3010\u8BF7\u6309\u4EE5\u4E0B\u9AA8\u67B6\u4F5C\u7B54\u3011",
          "1) \u80FD\u5426/\u5409\u51F6\uFF1A\u4EE5\u7528\u795E\u5BAB\u3001\u4E09\u4E59\u56DB\u5BAB\u5BF9\u5E74\u547D\u5BAB\u7684\u751F\u514B\u76D7\u6CC4+\u5408\u51B2\u5B9A\u8BBA\u3002",
          "2) \u65B9\u4F4D\uFF1A\u7528\u795E(\u6216\u7384\u6B66\u7B49\u5BF9\u5E94\u795E\u715E)\u843D\u5BAB \u2192 \u65B9\u4F4D+\u573A\u6240\u884D\u8C61\uFF0C\u843D\u5230\u5177\u4F53\u5904\u3002",
          "3) \u5E94\u671F\uFF1A\u7528\u795E\u5BAB\u5730\u76D8\u5947\u4EEA\u5B9A\u8FD1\u671F\u4E4B\u65E5\uFF1B\u5730\u76D8\u6697\u5E72\u652F\u5B9A\u8FDC\u671F\uFF1B\u53EF\u7528\u6CB3\u56FE\u6570\u5B9A\u6570\u5B57\u3002",
          "4) \u7406\u7531\uFF1A\u9010\u6761\u5F15\u7528\u76D8\u9762\u5143\u7D20\u4E0E\u683C\u5C40\u3002",
          "\u82E5\u5360\u95EE\u8981\u6C42\u5177\u4F53\u6570\u5B57(\u4EF7\u683C/\u5206\u6570/\u6570\u91CF/\u53F7\u7801)\uFF1A\u7528\u6CB3\u56FE\u6570(\u7528\u795E\u6216\u503C\u7B26\u5BAB\u5929\u5730\u76D8\u5E72\u2192\u6570\uFF0C\u7532\u4E593\xB78\u3001\u4E19\u4E017\xB72\u3001\u620A\u5DF15\xB710\u3001\u5E9A\u8F9B9\xB74\u3001\u58EC\u76781\xB76)\uFF0C\u6309\u65FA\u8870\u589E\u51CF\uFF0C\u7ED9\u51FA\u4E00\u4E2A\u6570\u6216\u533A\u95F4\u3002",
          "\u82E5\u4E3A\u5C04\u8986\u731C\u7269/\u8C1C\uFF1A\u7ED3\u5408\u7528\u795E\u5BAB\u516B\u5366\u7C7B\u8C61 + \u4E5D\u661F\u95E8\u795E\u5947\u4EEA\u4E4B\u884D\u8C61\uFF0C\u7ED9\u51FA\u6700\u53EF\u80FD\u7684\u7269\u8C61\u3002",
          "\u8BF7\u8F93\u51FA\uFF1A\u2460 \u7ED3\u8BBA\u4E00\u53E5\u8BDD \u2461 \u65B9\u4F4D \u2462 \u5E94\u671F/\u6570\u5B57 \u2463 \u8BE6\u7EC6\u7406\u7531\u3002"
        ].join("\n");
        return {
          system,
          user,
          context: { sanyi, yong, chartText, category: yong.category }
        };
      }
      async function predict(pan, question, opts = {}) {
        const prompt = buildPrompt(pan, question, opts);
        if (typeof opts.llm === "function") {
          const answer = await opts.llm(prompt.system, prompt.user);
          return { answer, prompt };
        }
        const err = new Error("LLM \u672A\u63A5\u5165\uFF1A\u8BF7\u4F20\u5165 opts.llm=(system,user)=>Promise<string>\uFF0C\u6216\u5728\u8DEF\u7531\u5C42\u7528 buildPrompt() \u7684\u7ED3\u679C\u81EA\u884C\u8C03\u7528\u6A21\u578B\uFF08\u5982 Gemini/Claude/GPT\uFF09\u3002");
  ...
  // lib/zhuanpan-predict.js
  var require_zhuanpan_predict = __commonJS({
    "lib/zhuanpan-predict.js"(exports, module) {
      var fs = null;
      var nodePath = null;
      try {
        fs = __require("fs");
      ...
      var { GONG_FANGWEI } = require_feipan_predict();
      var YONG_SHEN_RULES = [
        { category: "\u6C42\u8D22", keywords: ["\u6C42\u8D22", "\u8D22\u8FD0", "\u94B1", "\u8D5A", "\u6295\u8D44", "\u751F\u610F", "\u5229\u6DA6", "\u80A1"], yongshen: [{ kind: "men", name: "\u751F\u95E8" }, { kind: "gan", name: "\u620A" }], note: "\u751F\u95E8\u3001\u620A(\u8D22\u661F)\u65FA\u76F8\u9022\u751F\u4E3A\u5F97\uFF1B\u7A7A\u4EA1\u5165\u5893\u88AB\u514B\u4E3A\u635F\u3002" },
        { category: "\u4E8B\u4E1A", keywords: ["\u4E8B\u4E1A", "\u5DE5\u4F5C", "\u6C42\u804C", "\u5347\u804C", "\u6362\u5DE5\u4F5C", "\u8DF3\u69FD", "\u9879\u76EE"], yongshen: [{ kind: "men", name: "\u5F00\u95E8" }, { kind: "shen", name: "\u503C\u7B26" }], note: "\u5F00\u95E8\u65FA\u3001\u503C\u7B26\u5409\u3001\u4E0E\u5E74\u547D\u76F8\u751F\u5219\u987A\u9042\u3002" },
        { category: "\u529F\u540D", keywords: ["\u529F\u540D", "\u8003\u8BD5", "\u8003", "\u4E0A\u5CB8", "\u5F55\u53D6", "\u5B66\u4E1A"], yongshen: [{ kind: "men", name: "\u666F\u95E8" }, { kind: "xing", name: "\u5929\u8F85" }], note: "\u6587\u4E66\u770B\u666F\u95E8/\u5929\u8F85/\u4E01\u5947\uFF0C\u65FA\u76F8\u9022\u5409\u5219\u540D\u626C\u3002" },
        { category: "\u5B98\u53F8", keywords: ["\u5B98\u53F8", "\u8BC9\u8BBC", "\u8BCD\u8BBC", "\u6253\u5B98\u53F8", "\u7EA0\u7EB7", "\u5B98\u975E", "\u4EF2\u88C1"], yongshen: [{ kind: "men", name: "\u5F00\u95E8" }, { kind: "gan", name: "\u5E9A" }], note: "\u5F00\u95E8\u4E3A\u5B98\u957F\uFF1B\u5929\u76D8\u4E3A\u5BA2\u3001\u5730\u76D8\u4E3A\u4E3B\uFF0C\u751F\u6211\u514B\u5F7C\u5219\u5229\u3002" },
        { category: "\u5A5A\u59FB", keywords: ["\u5A5A\u59FB", "\u611F\u60C5", "\u7ED3\u5A5A", "\u5BF9\u8C61", "\u604B\u7231", "\u59FB\u7F18", "\u590D\u5408", "\u79BB\u5A5A"], yongshen: [{ kind: "shen", name: "\u516D\u5408" }, { kind: "gan", name: "\u4E59" }], note: "\u4E59\u5E9A\u76F8\u5408\u4E3A\u6210\uFF1B\u516D\u5408\u65FA\u5409\u3001\u88AB\u51B2\u514B\u5219\u6563\u3002" },
        { category: "\u75BE\u75C5", keywords: ["\u75BE\u75C5", "\u75C5", "\u5065\u5EB7", "\u8EAB\u4F53", "\u751F\u75C5", "\u624B\u672F", "\u4F4F\u9662"], yongshen: [{ kind: "xing", name: "\u5929\u82AE" }, { kind: "xing", name: "\u5929\u5FC3" }], note: "\u82AE\u65FA\u75C5\u91CD\uFF1B\u5929\u5FC3/\u751F\u95E8\u65FA\u514B\u82AE\u4E3A\u6108\uFF1B\u6B7B\u95E8\u3001\u82AE\u4E34\u5E74\u547D\u51F6\u3002" },
        { category: "\u5931\u7269", keywords: ["\u5931\u7269", "\u4E22", "\u627E", "\u627E\u56DE", "\u94A5\u5319", "\u4E22\u5931", "\u4E0D\u89C1", "\u6389", "\u5BFB\u7269", "\u88AB\u76D7", "\u5077"], yongshen: [{ kind: "shen", name: "\u7384\u6B66" }, { kind: "men", name: "\u4F24\u95E8" }], note: "\u7384\u6B66\u843D\u5BAB=\u5931\u7269/\u76D7\u5411\uFF1B\u4F24\u95E8\u5BFB\u7269\uFF1B\u843D\u5BAB\u5B9A\u65B9\u4F4D\u3001\u884D\u8C61\u5B9A\u7269\u3002" },
        { category: "\u51FA\u884C", keywords: ["\u51FA\u884C", "\u65C5\u884C", "\u8FDC\u884C", "\u51FA\u95E8", "\u642C\u5BB6", "\u8DEF\u9014"], yongshen: [{ kind: "men", name: "\u5F00\u95E8" }], note: "\u5F00\u95E8\u5409\u3001\u9A6C\u661F\u52A8\u5229\u884C\uFF1B\u4F24\u675C\u95E8\u3001\u9A6C\u7A7A\u5219\u963B\u3002" },
        { category: "\u884C\u4EBA", keywords: ["\u884C\u4EBA", "\u6765\u4E0D\u6765", "\u4F55\u65F6\u5230", "\u56DE\u6765", "\u6D88\u606F"], yongshen: [{ kind: "men", name: "\u5F00\u95E8" }], note: "\u7528\u795E\u4E34\u9A6C\u661F\u3001\u751F\u5E74\u547D\u3001\u95E8\u5409\u2192\u5FC5\u6765\uFF1B\u5165\u5893\u7A7A\u4EA1\u2192\u672A\u52A8\u3002" },
        { category: "\u5929\u6C14", keywords: ["\u5929\u6C14", "\u4E0B\u96E8", "\u4F1A\u4E0B\u96E8", "\u6674", "\u9634\u5929", "\u522E\u98CE", "\u96E8", "\u96EA", "\u53F0\u98CE", "\u66B4\u96E8", "\u4F1A\u4E0D\u4F1A\u4E0B"], yongshen: [{ kind: "xing", name: "\u5929\u84EC" }, { kind: "xing", name: "\u5929\u82F1" }], note: "\u96E8\u770B\u5929\u84EC/\u58EC\u7678\u3001\u6674\u770B\u5929\u82F1/\u4E19\u4E01\uFF0C\u4EE5\u5176\u5929\u76D8\u843D\u5BAB\u65FA\u8870\u3001\u95E8\u5BAB\u683C\u65AD\u9634\u6674\u98CE\u96EA\u3002" },
        { category: "\u6000\u5B55", keywords: ["\u6000\u5B55", "\u6000\u4E0A", "\u80FD\u4E0D\u80FD\u751F", "\u751F\u7537", "\u751F\u5973", "\u7537\u5B69", "\u5973\u5B69", "\u80CE", "\u4EA7", "\u5907\u5B55", "\u987A\u4EA7", "\u5256\u8179"], yongshen: [{ kind: "xing", name: "\u5929\u82AE" }, { kind: "men", name: "\u751F\u95E8" }], note: "\u4EA7\u80B2\u770B\u5929\u82AE(\u5B55\u6BCD)\u3001\u751F\u95E8(\u80CE\u4EA7)\uFF1B\u7537\u5973\u770B\u9634\u9633\uFF0C\u751F\u95E8\u65FA\u5409\u987A\u4EA7\uFF0C\u9022\u6B7B\u4F24\u95E8/\u5165\u5893\u7A7A\u4EA1\u5219\u51F6\u3002" },
        { category: "\u98CE\u6C34", keywords: ["\u98CE\u6C34", "\u9633\u5B85", "\u9634\u5B85", "\u575F", "\u5893\u5730", "\u4F4F\u5B85", "\u623F\u5B50", "\u5B85", "\u88C5\u4FEE", "\u5750\u5411"], yongshen: [{ kind: "men", name: "\u751F\u95E8" }, { kind: "men", name: "\u6B7B\u95E8" }], note: "\u9633\u5B85\u770B\u4E2D\u5BAB/\u503C\u4F7F/\u751F\u95E8\u65FA\u76F8\uFF0C\u9634\u5B85\u770B\u6B7B\u95E8/\u4E5D\u5730/\u575F\u8314\uFF1B\u4EE5\u5176\u4E0E\u5E74\u547D\u4E4B\u751F\u514B\u5B9A\u65FA\u8870\u5409\u51F6\u3002" },
        { category: "\u5BFB\u4EBA", keywords: ["\u5BFB\u4EBA", "\u627E\u4EBA", "\u4EBA\u5728\u54EA", "\u8D70\u5931", "\u5931\u8E2A", "\u4E0B\u843D", "\u884C\u8E2A", "\u8FFD\u8E2A", "\u8DD1\u54EA", "\u5728\u54EA\u91CC"], yongshen: [{ kind: "shen", name: "\u516D\u5408" }, { kind: "shen", name: "\u592A\u9634" }], note: "\u5BFB\u4EBA\uFF1A\u7537\u770B\u516D\u5408\u3001\u5973\u770B\u592A\u9634(\u6216\u5E74\u547D)\uFF0C\u5176\u843D\u5BAB\u5B9A\u65B9\u4F4D\uFF0C\u751F\u5E74\u547D\u3001\u95E8\u5409\u5219\u53EF\u5BFB\u89C1\u3002" },
        { category: "\u5C04\u8986", keywords: ["\u5C04\u8986", "\u731C", "\u6570\u5B57", "\u51E0\u4E2A", "\u591A\u5C11", "\u4EF7\u683C", "\u591A\u5C11\u94B1", "\u5206\u6570", "\u8003\u591A\u5C11", "\u51E0\u5206", "\u53F7\u7801", "\u8C1C", "\u662F\u4EC0\u4E48", "\u731C\u7269", "\u51E0\u6837"], yongshen: [{ kind: "shen", name: "\u503C\u7B26" }], note: "\u5C04\u8986/\u6570\u5B57\uFF1A\u4EE5\u503C\u7B26\u503C\u4F7F\u7528\u795E\u5BAB\u4E4B\u516B\u5366\u7C7B\u8C61 + \u5929\u5730\u76D8\u5E72\u4E4B\u6CB3\u56FE\u6570(\u7532\u4E593\xB78\u2026)\uFF0C\u7ED3\u5408\u65FA\u8870\u63A8\u5177\u4F53\u6570/\u7269\u3002" }
      ];
      function findGongByValue(map, target) {
        if (!map || !target) return "";
        for (const g of ["1", "2", "3", "4", "5", "6", "7", "8", "9"]) {
      ...
      function classifyQuestion(question, category) {
        ...
        return { category: "\u7EFC\u5408", note: "\u672A\u8BC6\u522B\u4E3A\u7279\u5B9A\u5360\u7C7B\uFF0C\u6309\u901A\u7528\u6CD5\uFF1A\u4EE5\u503C\u7B26\u503C\u4F7F\u3001\u7528\u795E\u5E74\u547D\u4E4B\u751F\u514B\u51B2\u5408\uFF0C\u7ED3\u5408\u5F15\u64CE\u5DF2\u7B97\u4E4B\u683C\u5C40/\u5409\u51F6\u7EFC\u5408\u8BBA\u65AD\u3002", yongshen: [], matched: false };
      }
      function locateYongShen(pan, item) {
        if (item.kind === "men") return findGongByValue(pan.baMen, item.name);
        if (item.kind === "shen") return findGongByValue(pan.baShen, item.name);
        if (item.kind === "xing") return findGongByValue(pan.jiuXing, item.name);
        if (item.kind === "gan") return findGongByValue(pan.tianPan, item.name);
        return "";
      }
      function selectYongShen(pan, question, opts = {}) {
        const cls = classifyQuestion(question, opts.category);
        const located = cls.yongshen.map((item) => {
          const g = locateYongShen(pan, item);
          const gf = GONG_FANGWEI[g] || {};
          ...
          return {
            ...
            fangwei: gf.fangwei || "",
            place: gf.place || "",
            tianGan: g ? pan.tianPan && pan.tianPan[g] : "",
            diGan: g ? pan.diPan && pan.diPan[g] : "",
            jiXiong: ja.jiXiongText || "",
            kongWang: !!ja.kongWang
          };
        });
        return { category: cls.category, note: cls.note, matched: cls.matched, located };
      }
      function serializeChart(pan) {
        ...
        lines.push(`\u3010\u57FA\u672C\u3011\u516C\u5386:${bi.date || ""} \u519C\u5386:${bi.lunarDate || ""}`);
        lines.push(`\u3010\u56DB\u67F1\u3011\u5E74${sz.year || ""} \u6708${sz.month || ""} \u65E5${sz.day || ""} \u65F6${sz.time || ""}`);
        lines.push(`\u3010\u5C40\u3011${pan.juShu && pan.juShu.fullName || ""}\u3000\u65EC\u9996:${pan.xunShou || ""}`);
        lines.push(`\u3010\u503C\u7B26\u3011${pan.zhiFuXing || ""}\u843D${pan.zhiFuGong || ""}\u5BAB\u3000\u3010\u503C\u4F7F\u3011${pan.zhiShiMen || ""}\u843D${pan.zhiShiGong || ""}\u5BAB`);
        if (pan.maStar && pan.maStar.gong) lines.push(`\u3010\u9A7F\u9A6C\u3011\u843D${pan.maStar.gong}\u5BAB(${pan.maStar.zhi || ""})`);
        if (Array.isArray(pan.kongWangGong) && pan.kongWangGong.length) lines.push(`\u3010\u7A7A\u4EA1\u5BAB\u3011${pan.kongWangGong.join("\u3001")}`);
        lines.push("\u3010\u4E5D\u5BAB\u3011\u6BCF\u5BAB\uFF1A\u5BAB\u4F4D(\u65B9\u4F4D) | \u516B\u795E \u4E5D\u661F \u516B\u95E8 | \u5929\u76D8\u5E72/\u5730\u76D8\u5E72(\u6697\u5E72) | \u5F15\u64CE\u5409\u51F6/\u514B\u5E94/\u6807\u8BB0");
        for (const g of ["1", "2", "3", "4", "5", "6", "7", "8", "9"]) {
          const gf = GONG_FANGWEI[g] || {};
          const ja = (pan.jiuGongAnalysis || {})[g] || {};
          const marks = [];
          if (ja.keYing) marks.push(ja.keYing.name);
          if (ja.menPo) marks.push("\u95E8\u8FEB");
          if (ja.kongWang) marks.push("\u7A7A\u4EA1");
          if (ja.yiMa) marks.push("\u9A7F\u9A6C");
          const shen = (pan.baShen || {})[g] || "";
          const xing = (pan.jiuXing || {})[g] || "";
          const men = (pan.baMen || {})[g] || "";
          const tg = (pan.tianPan || {})[g] || "";
          const dg = (pan.diPan || {})[g] || "";
          const ag = (pan.anGan || {})[g] || "";
          lines.push(`  ${g}\u5BAB(${gf.fangwei}): ${shen} ${xing} ${men} | \u5929${tg}/\u5730${dg}${ag ? "(\u6697" + ag + ")" : ""} | ${ja.jiXiongText || ""}${marks.length ? " " + marks.join("\xB7") : ""}`);
        }
        const an = pan.analysis || {};
        if (an.overallJiXiongText) lines.push(`\u3010\u5F15\u64CE\xB7\u603B\u4F53\u3011${an.overallJiXiongText}`);
        if (an.yongShen) lines.push(`\u3010\u5F15\u64CE\xB7\u7528\u795E\u3011${an.yongShen.name}\u843D${an.yongShen.direction}\u65B9(${an.yongShen.gongName}\u5BAB\uFF0C${an.yongShen.jiXiongText})`);
        if (Array.isArray(an.suggestions) && an.suggestions.length) lines.push("\u3010\u5F15\u64CE\xB7\u5EFA\u8BAE\u3011" + an.suggestions.join(" "));
        if (Array.isArray(pan.geju) && pan.geju.length) {
          lines.push("\u3010\u5F15\u64CE\xB7\u683C\u5C40\u3011" + pan.geju.map((x) => `${x.name}(${x.jiXiong === "ji" ? "\u5409" : x.jiXiong === "xiong" ? "\u51F6" : "\u5E73"}${x.gong ? "\xB7" + x.gong + "\u5BAB" : ""})`).join("\u3001"));
        }
        return lines.join("\n");
      }
      var _methodCache = null;
      function loadMethod(opts) {
        ...
        if (fs && nodePath) {
          try {
            _methodCache = fs.readFileSync(nodePath.join("/", "..", "kb", "zhuanpan", "jieduan-method.md"), "utf8");
          } catch (e) {
            _methodCache = "";
          }
        } else {
      ...
      function buildPrompt(pan, question, opts = {}) {
        const yong = selectYongShen(pan, question, opts);
        const chartText = serializeChart(pan);
        const yongLines = yong.located.length ? yong.located.map((y) => `  - ${y.name}\uFF1A\u843D${y.gong || "?"}\u5BAB(${y.fangwei || "?"}\uFF0C${y.place || ""})\uFF0C\u5929\u76D8\u5E72${y.tianGan || "?"}/\u5730\u76D8\u5E72${y.diGan || "?"}\uFF0C\u5F15\u64CE\u5224\u6B64\u5BAB\u300C${y.jiXiong || "?"}\u300D${y.kongWang ? "\xB7\u7A7A\u4EA1" : ""}`).join("\n") : "  - \uFF08\u672A\u5339\u914D\u7279\u5B9A\u5360\u7C7B\uFF0C\u6309\u503C\u7B26\u503C\u4F7F+\u5F15\u64CE\u5DF2\u7B97\u683C\u5C40/\u5409\u51F6\u901A\u7528\u8BBA\u65AD\uFF09";
        const system = [
          '\u4F60\u662F\u4E00\u4F4D\u7CBE\u901A"\u65F6\u5BB6\u8F6C\u76D8\u5947\u95E8\u9041\u7532"\u7684\u5360\u65AD\u5E08\u3002\u4E25\u683C\u4F9D\u636E\u4E0B\u65B9\u300A\u8F6C\u76D8\u5947\u95E8\xB7\u89E3\u65AD\u65B9\u6CD5\u7EB2\u8981\u300B\u53CA\u76D8\u4E0A\u5DF2\u9644\u7684\u5F15\u64CE\u89E3\u65AD(\u7528\u795E/\u683C\u5C40/\u4E5D\u5BAB\u5409\u51F6)\u63A8\u7406\uFF0C',
          "\u4F18\u5148\u91C7\u4FE1\u5F15\u64CE\u5224\u5B9A\u7684\u5409\u51F6\u4E0E\u683C\u5C40\uFF0C\u4E0D\u5F97\u8131\u79BB\u76D8\u9762\u81C6\u9020\uFF1B\u9010\u6B65\u5F15\u7528\u5177\u4F53\u5BAB\u4F4D\u5143\u7D20\u3001\u683C\u5C40\u4E0E\u751F\u514B\u5173\u7CFB\u3002\u6700\u7EC8\u7528\u7B80\u660E\u4E2D\u6587\u4F5C\u7B54\u3002",
          "",
          "=== \u89E3\u65AD\u65B9\u6CD5\u7EB2\u8981 ===",
          opts.includeMethod === false ? "(\u5DF2\u7701\u7565)" : loadMethod(opts)
        ].join("\n");
        const user = [
          `\u3010\u5360\u95EE\u3011${question || "(\u672A\u586B\u5199)"}`,
          opts.nianMingGan ? `\u3010\u6C42\u6D4B\u4EBA\u5E74\u547D\u5929\u5E72\u3011${opts.nianMingGan}` : "\u3010\u6C42\u6D4B\u4EBA\u5E74\u547D\u3011\u672A\u63D0\u4F9B",
          ...
          chartText,
          "",
          `\u3010\u5360\u7C7B\u3011${yong.category}\uFF08${yong.note}\uFF09`,
          "\u3010\u7528\u795E\u843D\u5BAB\u3011",
          yongLines,
          "",
          "\u3010\u8BF7\u6309\u4EE5\u4E0B\u9AA8\u67B6\u4F5C\u7B54\u3011",
          "1) \u80FD\u5426/\u5409\u51F6\uFF1A\u4EE5\u7528\u795E\u5BAB\u3001\u503C\u7B26\u503C\u4F7F\u5BF9\u5E74\u547D\u5BAB\u7684\u751F\u514B\u76D7\u6CC4+\u5408\u51B2\uFF0C\u7ED3\u5408\u5F15\u64CE\u5DF2\u5224\u5409\u51F6\u5B9A\u8BBA\u3002",
          "2) \u65B9\u4F4D\uFF1A\u7528\u795E(\u6216\u7384\u6B66\u7B49)\u843D\u5BAB \u2192 \u65B9\u4F4D+\u573A\u6240\u884D\u8C61\uFF0C\u843D\u5230\u5177\u4F53\u5904\u3002",
          "3) \u5E94\u671F\uFF1A\u7528\u795E\u5BAB\u5929/\u5730\u76D8\u5E72\u5B9A\u65E5\uFF1B\u7A7A\u4EA1\u5219\u586B\u5B9E\u51B2\u5B9E\uFF1B\u6709\u9A6C\u661F\u5219\u5BC5\u7533\u5DF3\u4EA5\uFF1B\u5165\u5893\u5219\u51FA\u5893\u3002",
          "4) \u7406\u7531\uFF1A\u9010\u6761\u5F15\u7528\u76D8\u9762\u5143\u7D20\u4E0E\u683C\u5C40\u3002",
          "\u82E5\u5360\u95EE\u8981\u6C42\u5177\u4F53\u6570\u5B57(\u4EF7\u683C/\u5206\u6570/\u6570\u91CF/\u53F7\u7801)\uFF1A\u7528\u6CB3\u56FE\u6570(\u7528\u795E\u6216\u503C\u7B26\u5BAB\u5929\u5730\u76D8\u5E72\u2192\u6570\uFF0C\u7532\u4E593\xB78\u3001\u4E19\u4E017\xB72\u3001\u620A\u5DF15\xB710\u3001\u5E9A\u8F9B9\xB74\u3001\u58EC\u76781\xB76)\uFF0C\u6309\u65FA\u8870\u589E\u51CF\uFF0C\u7ED9\u51FA\u4E00\u4E2A\u6570\u6216\u533A\u95F4\u3002",
          "\u82E5\u4E3A\u5C04\u8986\u731C\u7269/\u8C1C\uFF1A\u7ED3\u5408\u7528\u795E\u5BAB\u516B\u5366\u7C7B\u8C61 + \u4E5D\u661F\u95E8\u795E\u5341\u5E72\u4E4B\u884D\u8C61\uFF0C\u7ED9\u51FA\u6700\u53EF\u80FD\u7684\u7269\u8C61\u3002",
          "\u8BF7\u8F93\u51FA\uFF1A\u2460 \u7ED3\u8BBA\u4E00\u53E5\u8BDD \u2461 \u65B9\u4F4D \u2462 \u5E94\u671F/\u6570\u5B57 \u2463 \u8BE6\u7EC6\u7406\u7531\u3002"
        ].join("\n");
        return { system, user, context: { yong, chartText, category: yong.category } };
      }
      async function predict(pan, question, opts = {}) {
        const prompt = buildPrompt(pan, question, opts);
        if (typeof opts.llm === "function") {
        ...
        const err = new Error("LLM \u672A\u63A5\u5165\uFF1A\u8BF7\u4F20\u5165 opts.llm=(system,user)=>Promise<string>\u3002");
        err.code = "LLM_NOT_CONFIGURED";
        err.prompt = prompt;
        throw err;
      }
      module.exports = { classifyQuestion, selectYongShen, serializeChart, buildPrompt, predict, YONG_SHEN_RULES };
    }
  });

  // pwa/src/engine-entry.js
  var qimen = require_qimen();
  var feipanQimen = require_feipan_qimen();
  var feipanPredict = require_feipan_predict();
  var zhuanpanPredict = require_zhuanpan_predict();
  window.QM = {
    qimen,
    feipanQimen,
    feipanPredict,
    zhuanpanPredict,
    // 渲染常量
    JIU_GONG: qimen.JIU_GONG,
    JIU_XING: qimen.JIU_XING,
    BA_MEN: qimen.BA_MEN,
    BA_SHEN: qimen.BA_SHEN
  };
})();
