 ...
 */
const CACHE = 'qimen-pwa-yinju2';
const ASSETS = [
  './', './index.html', './style.css', './engine.bundle.js', './core/shanxiang.js', './core/wangshuai.js', './core/yingqi.js', './core/yongshen.js', './core/xiangyi.js', './core/timing.js', './core/leixiang.js', './core/severity.js', './core/converge.js', './core/yinju.js', './core/evidence.js', './core/casebook.js', './core/evaluate.js', './core/casestore.js', './core/revise.js', './knowledge/domains.json', './knowledge/symbols.json', './knowledge/domain-rules.json', './knowledge/timing-rules.json', './knowledge/leixiang.json', './knowledge/severity-rules.json', './knowledge/dimensions.json', './knowledge/yinju-rules.json', './llm.js', './app.js',
