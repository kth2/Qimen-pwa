 ...
 */
const CACHE = 'qimen-pwa-phase5-casebook';
const ASSETS = [
  './', './index.html', './style.css', './engine.bundle.js', './core/shanxiang.js', './core/wangshuai.js', './core/yingqi.js', './core/yongshen.js', './core/xiangyi.js', './core/timing.js', './core/evidence.js', './core/casebook.js', './core/casestore.js', './knowledge/domains.json', './knowledge/symbols.json', './knowledge/domain-rules.json', './knowledge/timing-rules.json', './llm.js', './app.js',
